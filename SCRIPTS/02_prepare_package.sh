...
# Airconnect
cp -rf ../linkease/applications/airconnect ./package/new/airconnect
sed -i "s,'enabled' '0','enabled' '1',g" package/new/airconnect/files/airconnect.config
cp -rf ../linkease/applications/luci-app-airconnect ./package/new/luci-app-airconnect
# luci-app-irqbalance
